...
async def main():
    ...
    input_path = "/Volumes/One Touch/Ollama Chatbot #1/prompts/task_lists/test_prompt_5_task_list.csv"
    output_path = "/Volumes/One Touch/Ollama Chatbot #1/prompts/task_lists/reformatted_task_list.csv"
    ...
    base_path = "/Volumes/One Touch/Ollama Chatbot #1/output"
